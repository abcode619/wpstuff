...
class NewsLetter_List extends WP_List_Table {
    ...
    function column_default($item, $column_name) {
        ...
        switch ($column_name) {
            ...
            case 'post_email':
                return !empty($item[$column_name]) ? '<a href="mailto:' . $item[$column_name] . '">' . $item[$column_name] . '</a>' : '';
            case 'user_name':
                return $item[$column_name];
            case 'post_status':
                return $item[$column_name];
    ...
    function no_items() {
        ...
        _e('No newsletter found.', 'farmtoyou');
    }
...
$NewsLetterListTable = new NewsLetter_List();
...
<div class="wrap">
    ...
    <?php echo __('Newsletter', 'farmtoyou'); ?>
    </h2>
